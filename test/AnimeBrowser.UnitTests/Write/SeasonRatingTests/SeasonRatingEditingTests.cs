    ...
    public class SeasonRatingEditingTests : TestBase
    {
        ...
        public void InitDb()
        {
            ...
            allSeasonRatings = new List<SeasonRating>
            {
                ...
                new SeasonRating { Id = 3, Rating = 5, Message = "Cool anime!", SeasonId = 5401, UserId = "15A6B54C-98D0-4396-90E7-C94761DBA977", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 4, Rating = 1, Message = "Very very bad....", SeasonId = 5405, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 5, Rating = 2, Message = "", SeasonId = 5401, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 6, Rating = 3, Message = "", SeasonId = 2, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 7, Rating = 4, Message = "", SeasonId = 1, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 8, Rating = 2, Message = "", SeasonId = 5401, UserId = "5879560D-65C5-4699-9449-86CC57EF3111", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 9, Rating = 5, Message = "", SeasonId = 5405, UserId = "5879560D-65C5-4699-9449-86CC57EF3111", IsAnimeInfoActive = true, IsSeasonActive = true },
                // For some reason, when episode/season was deleted, it was not deleted and still here
                new SeasonRating { Id = 912, Rating = 2, Message = "", SeasonId = 912, UserId = "5879560D-65C5-4699-9449-86CC57EF3111", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 913, Rating = 5, Message = "", SeasonId = 913, UserId = "5879560D-65C5-4699-9449-86CC57EF3111", IsAnimeInfoActive = true, IsSeasonActive = true },
                // For some reason, when user was deleted, it was not deleted and still here
                new SeasonRating { Id = 916, Rating = 2, Message = "", SeasonId = 2, UserId = "CF596B99-A0CC-463B-8090-4D156B40D433", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 917, Rating = 5, Message = "", SeasonId = 5401, UserId = "CF596B99-A0CC-463B-8090-4D156B40D433", IsAnimeInfoActive = true, IsSeasonActive = true }
            };
        }
        ...
        public async Task EditSeasonRating_ShouldWork(long id, SeasonRatingEditingRequestModel requestModel)
        {
            ...
            seasonRating.IsAnimeInfoActive = true;
            seasonRating.IsSeasonActive = true;
