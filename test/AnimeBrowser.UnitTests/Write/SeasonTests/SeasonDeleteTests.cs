...
namespace AnimeBrowser.UnitTests.Write.SeasonTests
{
    ...
    public class SeasonDeleteTests : TestBase
    {
        ...
        public void InitDb()
        {
            ...
            {
                new SeasonRating { Id = 1, Rating = 4, Message = "", SeasonId = 1, UserId = "15A6B54C-98D0-4396-90E7-C94761DBA977", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 2, Rating = 3, Message = "Not bad.", SeasonId = 2, UserId = "15A6B54C-98D0-4396-90E7-C94761DBA977", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 3, Rating = 5, Message = "Cool anime!", SeasonId = 3, UserId = "15A6B54C-98D0-4396-90E7-C94761DBA977", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 4, Rating = 1, Message = "Very very bad....", SeasonId = 1, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 5, Rating = 2, Message = "", SeasonId = 10, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 6, Rating = 3, Message = "", SeasonId = 20, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 7, Rating = 4, Message = "", SeasonId = 22, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 8, Rating = 2, Message = "", SeasonId = 2, UserId = "5879560D-65C5-4699-9449-86CC57EF3111", IsAnimeInfoActive = true, IsSeasonActive = true },
                new SeasonRating { Id = 9, Rating = 5, Message = "", SeasonId = 3, UserId = "5879560D-65C5-4699-9449-86CC57EF3111", IsAnimeInfoActive = true, IsSeasonActive = true },
            };
            ...
            allEpisodeRatings = new List<EpisodeRating> {
                new EpisodeRating { Id = 1, Rating = 4, Message = "", EpisodeId = 1, UserId = "15A6B54C-98D0-4396-90E7-C94761DBA977", IsAnimeInfoActive = true, IsSeasonActive = true, IsEpisodeActive = true },
                new EpisodeRating { Id = 2, Rating = 3, Message = "Not bad.", EpisodeId = 2, UserId = "15A6B54C-98D0-4396-90E7-C94761DBA977", IsAnimeInfoActive = true, IsSeasonActive = true, IsEpisodeActive = true },
                new EpisodeRating { Id = 3, Rating = 5, Message = "Cool anime!", EpisodeId = 3, UserId = "15A6B54C-98D0-4396-90E7-C94761DBA977", IsAnimeInfoActive = true, IsSeasonActive = true, IsEpisodeActive = true },
                new EpisodeRating { Id = 4, Rating = 1, Message = "Very very bad....", EpisodeId = 4, UserId = "65F041D2-7217-4EA6-9065-9C9AB6290B35", IsAnimeInfoActive = true, IsSeasonActive = true, IsEpisodeActive = true }
            };
        ...
        public async Task DeleteSeason_ShouldWork(long seasonId)
        {
            ...
            var sp = SetupDI(services =>
            {
                ...
                episodeRatingReadRepo.Setup(err => err.GetEpisodeRatingsByEpisodeIds(It.IsAny<IEnumerable<long>>()))
                    .Callback<IEnumerable<long>>(eIds => foundEpisodeRatings = allEpisodeRatings.Where(er => eIds.Contains(er.EpisodeId)))
                ...
                seasonWriteRepo.Setup(sw => sw.DeleteSeason(It.IsAny<Season>(), It.IsAny<IEnumerable<Episode>>(), It.IsAny<IEnumerable<SeasonRating>>(), It.IsAny<IEnumerable<EpisodeRating>>()))
                    .Callback<Season, IEnumerable<Episode>, IEnumerable<SeasonRating>, IEnumerable<EpisodeRating>>((s, e, sr, er) =>
                    {
                        ...
                        if (sr?.Any() == true)
                        {
                            foreach (var sRating in sr.ToList())
                            {
