...
{
    public class AnimeInfoActivationHandler : IAnimeInfoActivation
    {
        private readonly ILogger logger = Log.ForContext<AnimeInfoActivationHandler>();
        ...
        public AnimeInfoActivationHandler(IAnimeInfoRead animeInfoReadRepo, ISeasonRead seasonReadRepo, ISeasonRatingRead seasonRatingReadRepo,
        ...
        public async Task<AnimeInfo> Activate(long animeInfoId)
        {
            try
            {
                ...
                if (seasons?.Any() == true)
                {
                    ...
                    {
                        s.IsAnimeInfoActive = true;
                    }
                }
                animeInfo.IsActive = true;
