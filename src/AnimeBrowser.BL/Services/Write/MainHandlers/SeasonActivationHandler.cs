...
{
    public class SeasonActivationHandler : ISeasonActivation
    {
        private readonly ILogger logger = Log.ForContext<SeasonActivationHandler>();
        ...
        public SeasonActivationHandler(ISeasonRead seasonReadRepo, ISeasonRatingRead seasonRatingReadRepo, IEpisodeRead episodeReadRepo, IEpisodeRatingRead episodeRatingReadRepo,
        ...
        public async Task<Season> Activate(long seasonId)
        {
            try
            {
